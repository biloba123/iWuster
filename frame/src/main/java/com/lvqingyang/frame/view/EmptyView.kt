package com.lvqingyang.frame.view
...
public open class EmptyView(context: Context?, attrs: AttributeSet?) : FrameLayout(context, attrs) {
    ...
    companion object {
        public const val STATE_LOAD: Byte=1
        public const val STATE_FAIL: Byte=2
        public const val STATE_EMPTY: Byte=3
        public const val STATE_NO_CONNECT: Byte=4
        public const val STATE_SUCCESS: Byte=5
    }
